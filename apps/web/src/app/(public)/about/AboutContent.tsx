  ...
  return (
    <>
      ...
      <section className="relative h-[52vh] min-h-[440px] overflow-hidden bg-sidebar flex items-end">
        <Image src="https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?w=1600&auto=format&fit=crop&q=50" alt="" fill className="object-cover object-center opacity-30" priority />
        ...
        <motion.div
          ...
          <span className="font-display font-extrabold text-3xl text-primary leading-none">30+</span>
          <span className="text-sidebar-foreground/45 text-[9px] uppercase tracking-[0.4em]">Countries</span>
        </motion.div>
