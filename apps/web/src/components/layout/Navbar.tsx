  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full flex items-center justify-between">
        ...
        {/* Logo */}
        <Link href="/" className="flex items-center gap-2 flex-shrink-0 group" style={{ paddingTop: '4px', paddingBottom: '4px' }} aria-label="LTIC SARL — Home">
          {/* eslint-disable-next-line @next/next/no-img-element */}
          <img src="/ltic-logo.png" alt="LTIC SARL" className="h-9 w-auto object-contain translate-x-2" />
        ...
        {/* Mobile hamburger */}
        <button
          className="lg:hidden p-2 min-h-[44px] min-w-[44px] flex items-center justify-center rounded-sm hover:bg-muted transition-colors"
