...
async function seed() {
  ...
  await db.insert(categories).values([
    ...
    },
    {
      ...
      slug: "generators",
      descriptionEn: "Diesel and gas generators for industrial and commercial use — available for purchase and supply across Cameroon.",
      descriptionFr: "Groupes électrogènes diesel et gaz pour usage industriel et commercial — disponibles à la vente au Cameroun.",
  ...
  await db.insert(products).values([
    ...
    },
    {
      ...
      slug: "bean-seeds",
      descriptionEn: "Cameroonian bean seeds — white, red and mixed varieties. Available in bulk for local markets and export.",
      descriptionFr: "Graines de haricots camerounaises — variétés blanches, rouges et mélangées. Disponibles en vrac pour marchés locaux et export.",
      categoryId: foodCat.id,
    ...
    },
    {
      ...
      descriptionFr: "Maïs séché — grain entier et moulu. Issu des exploitations camerounaises, disponible en achat en vrac.",
      categoryId: foodCat.id,
    ...
    // ── Generators ─────────────────────────────────────────────────────────
    {
      ...
      descriptionEn: "50kVA diesel generator for commercial and industrial applications. Available for sale across Cameroon.",
      descriptionFr: "Groupe électrogène diesel 50kVA pour applications commerciales et industrielles. Disponible à la vente au Cameroun.",
